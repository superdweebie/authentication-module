...
return array(
    'sds' => array(
        ...
        'jsonRpcSmdGenerator' => array(
            'sds.auth' => array(
                'path' => 'vendor/superdweebie/auth-module-smd-client/public/js/dojo_src/Sds/AuthModule/Smd.json',
                'format' => 'json', // dojo | json
                'dojoModule' => 'Sds/AuthModule/Smd' //Only required if dojo format is selected
            ),
        ),
